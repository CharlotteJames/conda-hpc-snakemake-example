...
Instructions to do these steps can be found in the (week_8_homework.md)[homework from week 8]. There will also be a drop-in session before week 9 teaching (9:30am - 10am) where we will help you complete this setup.
